function [R,trace] = sampleRewardsAllStates(solution,nrStarts,maxNrSteps,nrRuns)
...
if nrStarts~=min(find(abs(problem.startCum - 1) < 1e-10))
    error('please take care of this before calling the function')
end
start=1:nrStarts;
